========================================================================
    APPLICATION : Vue d'ensemble du projet clientIHM
========================================================================

AppWizard a créé cette application clientIHM pour vous.  

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application clientIHM.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé clientIHM.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
