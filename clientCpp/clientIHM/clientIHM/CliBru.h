...
#pragma endregion
	...
	private: System::Void connectBtn_Click(System::Object^  sender, System::EventArgs^  e) {
				 if(state)
				 {
					 ...
					 //remise à zéro de la fenetre
					 this->me_nom->Text = "";
					 this->me_level->Text = "";
					 this->me_speed->Text = "";
					 this->me_strench->Text = "";
					 this->me_life->Text = "";
					 ...
					 this->strb3_me->Text = "";
					 this->lifeb3_me->Text = "";
					 this->me_img->Image = nullptr;
					 this->imgb1_me->Image = nullptr;
					 this->imgb2_me->Image = nullptr;
					 this->imgb3_me->Image = nullptr;
					 //coteohther
					 this->other_nom->Text = "";
					 this->other_level->Text = "";
					 this->other_speed->Text = "";
					 this->other_strench->Text = "";
					 this->other_life->Text = "";

					 this->nameb1_other->Text = "";
					 this->lvlb1_other->Text = "";
					 this->spb1_other->Text = "";
					 this->strb1_other->Text = "";
					 this->lifeb1_other->Text = "";

					 this->nameb2_other->Text = "";
					 this->lvlb2_other->Text = "";
					 this->spb2_other->Text = "";
					 this->strb2_other->Text = "";
					 this->lifeb2_other->Text = "";

					 this->nameb3_other->Text = "";
					 this->lvlb3_other->Text = "";
					 this->spb3_other->Text = "";
					 this->strb3_other->Text = "";
					 this->lifeb3_other->Text = "";
					 this->other_img->Image = nullptr;
					 this->imgb1_other->Image = nullptr;
					 this->imgb2_other->Image = nullptr;
					 this->imgb3_other->Image = nullptr;
					 ...
					 if(IMGACT)
					 {
						 ...
						 if(c->ImageMe(image,imageb1,imageb2,imageb3))
						 {
							 ...
							 if(image.length()!=0)
							 {
								...
								w->Write(data);
								w->Close();*/
								System::IO::MemoryStream^ imgMem = gcnew System::IO::MemoryStream(data);
								this->me_img->Image = Image::FromStream(imgMem);
							 ...
							 if(imageb1.length()!=0)
							 {
								...
								System::IO::MemoryStream^ imgMem = gcnew System::IO::MemoryStream(data);
								this->imgb1_me->Image = Image::FromStream(imgMem);
							 ...
							 if(imageb2.length()!=0)
							 {
								...
								System::IO::MemoryStream^ imgMem = gcnew System::IO::MemoryStream(data);
								this->imgb2_me->Image = Image::FromStream(imgMem);
							 ...
							 if(imageb3.length()!=0)
							 {
								...
								System::IO::MemoryStream^ imgMem = gcnew System::IO::MemoryStream(data);
								this->imgb3_me->Image = Image::FromStream(imgMem);
							 } else
								 this->imgb3_me->Image = nullptr;
						 }
					 }
					 ...
					 if(IMGACT)
					 {
						 ...
						 if(c->ImageOther(image,imageb1,imageb2,imageb3))
						 {
							 ...
							 if(image.length()!=0)
							 {
								...
								System::IO::MemoryStream^ imgMem = gcnew System::IO::MemoryStream(data);
								this->other_img->Image = Image::FromStream(imgMem);
							 } else {
								 this->other_img->Image = nullptr;
							 }
								 //this->other_img->Image = Image::;
							 ...
							 if(imageb1.length()!=0)
							 {
								...
								System::IO::MemoryStream^ imgMem = gcnew System::IO::MemoryStream(data);
								this->imgb1_other->Image = Image::FromStream(imgMem);
							 } else
							 {
								 this->imgb1_other->Image = nullptr;
							 }
							 ...
							 if(imageb2.length()!=0)
							 {
								...
								System::IO::MemoryStream^ imgMem = gcnew System::IO::MemoryStream(data);
								this->imgb2_other->Image = Image::FromStream(imgMem);
							 } else
							 {
								 this->imgb2_other->Image = nullptr;
							 }
							 ...
							 if(imageb3.length()!=0)
							 {
								...
								System::IO::MemoryStream^ imgMem = gcnew System::IO::MemoryStream(data);
								this->imgb3_other->Image = Image::FromStream(imgMem);
							 } else{
